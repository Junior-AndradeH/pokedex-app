    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          const SizedBox(height: 10.0),
          _sizedBox(context, "Defense", _def!.toString(), _def! / 100),
          const SizedBox(height: 10.0),
          _sizedBox(context, "Sp. Atk", _spAtk!.toString(), _spAtk! / 100),
          const SizedBox(height: 10.0),
          _sizedBox(context, "Sp. Def", _spDef!.toString(), _spDef! / 100),
          const SizedBox(height: 10.0),
          _sizedBox(context, "Speed", _speed!.toString(), _speed! / 100),
          const SizedBox(height: 10.0),
          _sizedBox(context, "Total", _total!.toString(), _total! / 100),
        ],
      ),
    );
  }
